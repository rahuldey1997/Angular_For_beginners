...
import { CustomValidator } from '../reactive-forms/validators/noSpaceAllowed.validator';
import { UserNameValidators } from '../reactive-forms/validators/userName.validator';
@Component({
  selector: 'app-retriving-form-data-and-resetting-form',
  standalone: true,
  imports: [ReactiveFormsModule, CommonModule],
  templateUrl: './retriving-form-data-and-resetting-form.component.html',
  styleUrl: './retriving-form-data-and-resetting-form.component.css'
})
export class RetrivingFormDataAndResettingFormComponent implements OnInit{
  title:string='Resetting Reactive Form And Retriving Reactive Form Data'
